...
const empListData = {
  columns: [
    { id: 'sl', name: 'sl', align: 'center', headerName: 'Sl' },
    { id: 'paymentMonth', name: 'paymentMonth', align: 'center', headerName: 'Payment Month' },
    { id: 'paymentDate', name: 'paymentDate', align: 'center', headerName: 'Payment Date' },
    { id: 'paidAmount', name: 'paidAmount', align: 'center', headerName: 'Paid Amount' },
    { id: 'paymentType', name: 'paymentType', align: 'center', headerName: 'Payment Type' },
